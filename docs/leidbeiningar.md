# Sterkir pabbar — leiðbeiningar fyrir vefstjórn

Hvert einasta orð á sterkirpabbar.is kemur úr einu skjali sem þú átt. Þú breytir því,
...
**Ekkert fer í loftið fyrr en þú ýtir á Publish.**

Studioið vistar jafnóðum meðan þú skrifar, en það er bara uppkast — ekki síðan sjálf.
Þú mátt prófa þig áfram, skrifa vitleysu, skipta um skoðun og hætta í miðju kafi.
Síðan breytist ekki neitt á meðan.
...
Sumu má ekki breyta hvernig sem er — ekki til að stýra þér, heldur af því að annaðhvort
...
- Þú getur ekki eytt skjalinu eða tekið síðuna úr birtingu. Þeir takkar eru einfaldlega
  ekki til staðar.
- Ef eitthvað sleppur samt í gegn sem síðan ræður ekki við, byggir hún sig upp með
  síðustu góðu útgáfunni í staðinn. Síðan fer aldrei niður.
- Sími og samfélagsmiðlar mega vera auðir. Skildu reitinn eftir tóman og hlekkurinn
  hverfur af síðunni — betra en hlekkur á reikning sem er ekki til.
- Þú sérð alltaf hverju þú breyttir áður en þú birtir, og eldri útgáfur eru geymdar.

## Ef eitthvað lítur skringilega út

- Bíddu í tvær mínútur og endurhlaðið síðuna — `Cmd+Shift+R` á Mac, `Ctrl+F5` á Windows.
- Er textinn þinn enn ekki kominn? Athugaðu hvort þú hafir örugglega ýtt á **Publish**,
  ekki bara skrifað.
